...
type Client struct {
	...
	// 客户端类型标识字段
	BearerOnly             bool   `json:"bearer_only"`
...
type ClientData struct {
	...
	AuthorizationServicesEnabled       bool                           `json:"authorization_services_enabled"`
	FullScopeAllowed                   bool                           `json:"full_scope_allowed"`
	NodeReRegistrationTimeout          int32                          `json:"node_re_registration_timeout"`
	...
	AuthenticationFlowBindingOverrides map[string]string              `json:"authentication_flow_binding_overrides"`
	Attributes                         map[string]string              `json:"attributes"`
	ProtocolMappers                    []ProtocolMapperRepresentation `json:"protocol_mappers"`
...
// 	Access datatypes.JSONType[map[string]any] `json:"access,omitempty" gorm:"type:json"`
//
